                  ...
                  <div className="space-y-8 mb-10">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${siteConfig.email}`} className="text-lg font-semibold text-white hover:text-red-400 transition-colors">
                          {siteConfig.email}
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`tel:${siteConfig.phone}`} className="text-lg font-semibold text-white hover:text-red-400 transition-colors">
                          {siteConfig.phone}
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-white">{siteConfig.address}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-gray-700 pt-8">
                    ...
                    <div className="flex gap-4">
                      {siteConfig.social.twitter && (
                        <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-800 hover:bg-red-600 rounded-xl flex items-center justify-center transition-all duration-300 group" aria-label="Twitter">
                      ...
                      {siteConfig.social.linkedin && (
                        <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-800 hover:bg-red-600 rounded-xl flex items-center justify-center transition-all duration-300 group" aria-label="LinkedIn">
                          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {siteConfig.social.github && (
                        <a href={siteConfig.social.github} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-800 hover:bg-red-600 rounded-xl flex items-center justify-center transition-all duration-300 group" aria-label="GitHub">
                          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
