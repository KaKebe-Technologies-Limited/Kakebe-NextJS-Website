      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-black">
            {[
              { step: "01", title: "Apply", description: "Fill out our application form with your background and goals." },
              { step: "02", title: "Interview", description: "We'll schedule a conversation to learn more about you." },
              { step: "03", title: "Onboard", description: "Get access to our space, mentors, and resources." },
              { step: "04", title: "Build", description: "Start creating solutions that matter." },
            ].map((item) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <SectionReveal>
              ...
              <div className="space-y-8">
                {[
                  { title: "World-Class Curriculum", description: "Learn from industry professionals with real-world experience." },
                  { title: "Hands-On Projects", description: "Build actual products from day one, not just classroom exercises." },
                  { title: "Mentorship Network", description: "Get paired with experienced mentors who've been where you want to go." },
                  { title: "Community Access", description: "Join a network of builders, investors, and industry leaders." },
                  { title: "Career Support", description: "We help you land your dream job or launch your startup." },
                ].map((benefit) => (
                  <div key={benefit.title} className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 font-medium">{benefit.description}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <SectionReveal>
              <div className="bg-gradient-to-br from-red-600 to-black rounded-3xl p-12 text-white shadow-2xl">
                <h3 className="text-3xl font-black mb-6">Ready to Start Your Journey?</h3>
                <p className="text-lg text-red-50 mb-8 font-medium">
                  Applications are open for our next cohort. Don't miss your chance to join Uganda's most dynamic innovation community.
                </p>
                ...
                <div className="mt-10">
                  <Link href="/contact">
                    <Button variant="primary" size="lg" className="w-full bg-white hover:bg-red-50 transition-colors py-4">
                      <span className="text-black font-black uppercase tracking-wider">Apply Now</span>
                    </Button>
                  </Link>
                </div>
              </div>
